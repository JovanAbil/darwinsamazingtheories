...
export const navigationItems: NavItem[] = [
  { title: "Home", href: "/", icon: "Home", description: "Text goes here" },
  {
    ...
    children: [
      { title: "Claim 1", href: "/page-1", icon: "FileText", description: "Text goes here" },
      { title: "Claim 2", href: "/page-2", icon: "FileText", description: "Text goes here" },
      { title: "Claim 3", href: "/page-3", icon: "FileText", description: "Text goes here" },
      { title: "Claim 4", href: "/page-4", icon: "FileText", description: "Text goes here" },
      { title: "Claim 5", href: "/page-5", icon: "FileText", description: "Text goes here" },
    ],
  },
